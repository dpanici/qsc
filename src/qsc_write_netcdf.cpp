...
void Qsc::write_netcdf(std::string filename)
{
  ...
  nc.put("grid_min_torsion", grid_min_torsion, "min_torsion of the magnetic axis, minimizing only over the phi grid points and not interpolating in between", "1/meter");
