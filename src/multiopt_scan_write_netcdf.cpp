...
void MultiOptScan::write_netcdf()
{
  ...
  nc.put(n_scan_dim, "scan_B20_mean", scan_B20_mean, "For each configuration kept from the scan, Average over arclength along the magnetic axis of B20", "Tesla/(meter^2)");
  ...
  nc.put(n_scan_dim, "scan_weight_DMerc_times_r2", scan_weight_DMerc_times_r2, " ", "dimensionless");
  nc.put(n_scan_dim, "scan_min_DMerc_times_r2", scan_min_DMerc_times_r2, " ", "dimensionless");
